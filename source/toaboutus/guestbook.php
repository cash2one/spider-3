            ...
            <!--[if IE 9 ]>
                ...
                <!--[if (gt IE 9)|!(IE)]>
                    ...
                    <head>
                        ...
                        <script type="text/javascript" src="http://static.to8to.com/gb_js/common_new_forold.js?v=1484119175"></script>
                        <script type="text/javascript">var city_id = getCookie('townid', 1);
                            city_id = city_id ? city_id: 1130;</script>
                    ...
                    <body class="narrow_980">
                        <div class="global_wrap" id='gloWrap'>
                                    ...
                                    <div class="header_menu">
                                        <ul>
                                            ...
                                            <li class="has_secondMenu ">
                                                ...
                                                <dl>
                                                    <dd>
                                                        <a href="http://www.to8to.com/riji/" searchtage="1_3_18_159">装修日记</a>
                                            ...
                                            <li class="has_secondMenu">
                                                <a href="http://mall.to8to.com/" searchtage="1_23_18_169">
                                                    <em class="menu_arrow"></em>
                                                    <span>家居商城</span></a>
                                                <dl>
                                                    <dd>
                            ...
                            <script type="text/javascript">var current_city = cityName;
                                ...
                                "side_slider");</script>
                            <style type="text/css">.content{ width:720px; margin:0 auto; padding-top:100px;} .content .top{background:url(img/feed_back_01.png) no-repeat; width:720px; height:78px;} * html .content .top{filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src="img/feed_back_01.png"); background:none;} .content .top a{width:122px; height:36px; float:right; margin:28px 19px 0 0; _background:#fff;_filter:alpha(opacity=0);position:relative;} .content .f_z{ background:url(img/feed_back_z.png) repeat-y; padding:25px 0 28px 45px;} .content .f14{ font-size:14px; font-weight:bold; text-align:right;} .content .f60{ color:#f00; margin-right:3px;} .content #text{ margin-left:5px; height:18px; line-height:18px; padding:1px 3px; width:205px; margin-right:5px;} .input_on,.input_move{border:1px solid #cc6633;} .input_off,.content .text,.input_out{border:1px solid #CCC;} .submit{ background:url(img/botton.jpg) no-repeat; width:131px; height:50px; float:left; margin:15px 0 0 5px; border:0;} .content .f_f{background:url(img/feed_back_03.png) no-repeat; display:block; width:720px; height:18px;} * html .content .f_f{filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src="img/feed_back_03.png"); background:none;} .feed_back_cg{ background:url(img/feed_back_cg.gif) no-repeat left 5px; display:inline;float:left;height:115px;margin:101px 0 0px 100px; padding:0 0 80px 100px; line-height:34px; color:#f60;} .feed_back_cg b{ font-size:35px; color:#669900;} .feed_back_cg .f_cg{ width:170px; height:40px; float:left; margin-top:5px;} .cl{ width:100%; display:block; height:0px; font-size:0; clear:both;}</style>
                            <div id="content">
