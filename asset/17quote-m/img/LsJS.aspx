var LR_b15e3='DAE4E15B5FEE46328C80BB9E80EE238E';if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
...
var LR_siteid = '85079174';
var LR_isMobile = 1;
var LR_lng = 'cn';
var LR_ssl = 0;
var LiveReceptionCode_isonline = 0;
LR_b15e3=LR_b15e3.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_044f9=LR_b15e3.replace(/4/g,'8').replace(/5/g,'3');var LR_DJFE=LR_044f9.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	var _lr_helpalt_on=unescape("");
	var _lr_helpsrc_on=unescape("http%3a%2f%2fdkt.zoosnet.net%2fsite%2f85079174%2fmonline_cn.png");
	var _lr_helpalt_of=unescape("");
	var _lr_helpsrc_of=unescape("http%3a%2f%2fdkt.zoosnet.net%2fsite%2f85079174%2fmonline_cn.png");
	...
	var _lr_mobileinviteimgsrc=unescape("http%3a%2f%2fdkt.zoosnet.net%2fsite%2f85079174%2fminvite_cn.png");
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&GGKF='+LR_DJFE;
