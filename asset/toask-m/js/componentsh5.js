...
_script.src = "//static.to8to.com/gb_js/to8torsaszb.js";
...
(function(window, $) {
    ...
    Components.shareWechat = function(options) {
        ...
        Components.loadScript('https://res.wx.qq.com/open/js/jweixin-1.0.0.js', function() {
            Components.loadScript('//m.to8to.com/js/wx.js?20150210', function() {
                /*********** 微信分享 ************/
                try {
                    var shareConfig = {
    ...
    Components.InitCityCookie = function() {
        var url = "//m.to8to.com/index/Citycookie/city/" + "?" + Math.random();
        $.get(url);
    }
    ...
    Components.getAPPCity = function(options) {
        ...
        if (urlData['token'] !== undefined || urlData['to8to_token'] !== undefined) {
            ...
            $.ajax({
                type: 'get',
                url: '//m.to8to.com/index.php/open/getcity',
                data: token,
            ...
            if(ua.match(/MicroMessenger/i) == 'micromessenger'){
                ...
                var t = setTimeout(function() {
                    ...
                    if (!startTime || endTime - startTime < config.timeout + 200) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: '//mobileapi.to8to.com/smallapp.php',
                            dataType: 'jsonp',
                            ...
                            success: function (res) {
                                ...
                                if(androidurl){
                                    ...
                                    window.location.href = '//pic.to8to.com/app/android/to8to/20161018_e61188c21265c5f737c6GGcakiJ0WYT3.apk';
                                }
                            },
                            error: function(res) {
                                window.location.href = '//pic.to8to.com/app/android/to8to/20161018_e61188c21265c5f737c6GGcakiJ0WYT3.apk';
