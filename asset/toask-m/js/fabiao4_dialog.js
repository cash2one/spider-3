...
_scriptMd5.src = "//static.to8to.com/gb_js/jQuery.md5.js";
...
if(typeof RSAUtilszb == "undefined"){
    ...
    elemetRSA.src = "//static.to8to.com/gb_js/to8torsaszb.js";
...
(function($, that) {    
    ...
    function initEvent() {
       ...
       /* $('body').on('focus','input',function(){
                $('#banner-wx-new-init').css('position','static');
                $('.whan-ad').height(53);
    ...
    function ask_fzprice(data,homeMsg,banbao_price,other){
            ...
            var str = '<div class="dialog-ask-box">'
                        ...
                        +'<p class="holiday-text"><span>*</span>稍后装修管家将致电您，为您提供免费装修资询服务。</p>'
                        +'</div>'
            ...
            if(date1_unix<=date_unix && date_unix<=date2_unix){
                $('.holiday-text').html('亲爱的业主，因公司年会放假(1月8日-1月9日)，很抱歉未能及时与您联系。我们将于1月10日立即给您回电，免费提供装修咨询服务。');
                $('.whan-ad-ask .fabiaoqu-ask').height(355);
            }
            ...
                $('.holiday-text').html('亲爱的业主，因春节期间放假(1月23日-2月2日)，很抱歉未能及时与您联系。年后我们将第一时间给您回电，免费提供装修咨询服务！祝您新春愉快，阖家幸福！');
                $('.whan-ad-ask .fabiaoqu-ask').height(374);
                $('.whan-ad').css({'bottom':'374px'});
            }else{
                $('.whan-ad').css({'bottom':'334px'});
            }
    ...
    function DateUnix1(){
        ...
            $('.holiday-text').html('亲爱的业主，因春节期间放假(1月23日-2月2日)，很抱歉未能及时与您联系。年后我们将第一时间给您回电，免费提供装修咨询服务！祝您新春愉快，阖家幸福！');
            $('.whan-ad-ask .fabiaoqu-ask').height(374);
            $('.whan-ad').css({'bottom':'374px'});
            $('.holiday-text').css({'margin-bottom':'40px'});
        }else{
            $('.whan-ad').css({'bottom':'334px'});
        }
    }
