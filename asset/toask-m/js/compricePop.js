		...
		t8s_fzprice: function(data,homeMsg,banbao_price){
		    ...
		    for(var i = 0; i< homeMsg.length; i++) {
		     ...
		     var  fruit_html = '<div class="t8s-fruit-price">'+
				                ...
				                '<p class="holiday-text" style="font-size: 12px;color: #33bf82;text-align: left;">*稍后装修管家将致电您，为您提供免费装修咨询服务。</p>';
			...
			if(date1_unix<=date_unix<=date2_unix){
		...
		t8s_newprice: function(data){
			...
			var fruit_html = '<div class="t8s-fruit-price">'+
			                ...
			                '<div class="t8s-price-list">'+
			                 	...
			                 	'</ul>'+
			                '</div>'+
			                '<p class="holiday-text"  style="font-size: 12px;color: #fe5f00;text-align: left;margin-top: 10px;">* 稍后装修管家将致电您，为您提供免费装修咨询服务。</p>'+
