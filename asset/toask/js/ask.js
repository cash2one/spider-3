...
jq(function(){
    ...
    questionBox.find('textarea').placeholder({oLabel: 'span'});
    ...
    function zxjrApplyBox() {
        ...
        jq('#phone_zxjr_box').placeholder({oLabel: 'span'});
...
function SubmitZXR(phone, questionText, myPtag, type)
{
    ...
    if (type == 2) {
        jq.ajax({
            ...
            'data': {'type': 'zxr', 'phone': phone, 's_sourceid': 20, 'sourceid': 3, 'ptag': tag, 'questionText': questionText},
...
function SubmitPhone(phone)
{
    ...
    jq(".coupon").bind('click',function(){
        ...
        jq(":submit.btn_org").click(function(evt){
            ...
            var a = jq('#zxbj_phonenum').checkForm({className:"add_wrong",content:["请填写手机号码","请正确填写手机号码"],type:[1,2], reg:0,checkFormType:obj, displayNum:true,labl:'i', lablClass: 'ico_error'});
            if(a == 0){
                jq.ajax({
                    type: "GET",
                    url: "/my/get_moblie_yz.php",
