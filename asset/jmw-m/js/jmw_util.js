...
Utils.isPhone = function(str) {
//    var regexp = /(^[0-9]{3,4}\-?[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^1[3,5,8,7]{1}[\d]{9}$)|(^\([0-9]{3,4}\)[0-9]{3,8}$)/;
...
//    var regexp = /(^1[3,5,8,7]{1}[\d]{9}$)|(^09[0-9]{2}\-?[0-9]{6}$)/;
...
//	var regexp = /^[\w-#——\u4e00-\u9fa5]{3,75}$/;
	// var regexp = /^[\u4e00-\u9fa5][\w#\u4e00-\u9fa5]{2,74}$/;
